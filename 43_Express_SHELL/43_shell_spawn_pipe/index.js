...
//child_process.spawn запускает новый процесс с помощью заданной команды.
...
const findstr = spawn('findstr', ['/c:in']); //помагает отыскивать строки из главного потока, [шаблон] like(in);
